...
class local_eventocoursecreation_course_creation {
    ...
    public function __construct() {
        ...
        $this->eventoservice = new \local_evento\local_evento_evento_service();
    ...
    public function course_sync(progress_trace $trace, $categoryid = null, $force = false) {
        ...
        try {
            ...
            foreach ($veranstalter as $ver) {
                print_r($ver);
                $eventolinos = $this->eventoservice->get_events_by_veranstalter($ver->benutzerVorname);
                foreach ($eventolinos as $evo) {
                    print_r($evo->anlassNummer);
                    print_r("\n");
                    print_r($evo->anlassVeranstalter);
                    print_r("\n");
                }
            }
