...
$string['moduldescriptionheading'] = 'Titel über der Beschreibung';
$string['moduldescriptionheading_help'] = 'Text, der innerhalb der Seite als Titel über die Modulbeschreibung gesetzt wird. Leer lassen für keinen Titel. Eine Änderung schreibt die Seite jedes Kurses beim nächsten Lauf neu.';
$string['moduldescriptionshowects'] = 'Credits anzeigen';
$string['moduldescriptionshowects_help'] = 'Wenn aktiviert, wird ein Satz mit den Credits des Moduls in die Moduleigenschaften der Beschreibung geschrieben. Dafür ist ein zweiter Webservice-Aufruf pro Kurs nötig, der nur solange gemacht wird, wie die Einstellung aktiv ist.';
$string['moduldescriptionectstext'] = 'Satz zu den Credits';
$string['moduldescriptionectstext_help'] = 'Satz, der in die Moduleigenschaften der Beschreibung geschrieben wird und die Credits des Moduls nennt. [ECTS] wird durch den Evento-Wert anlass_ECTS ersetzt. Leer lassen für keinen Satz, das spart auch den zusätzlichen Webservice-Aufruf.';
$string['moduldescriptionectstag'] = 'Element des Credits-Satzes';
$string['moduldescriptionectstag_help'] = 'HTML-Element, in das der Satz gesetzt wird und das damit die Schriftgrösse bestimmt. Erlaubt sind dt, dd, p, div, h1 bis h6, strong, em und span. dt setzt ihn in die Liste der Moduleigenschaften, jedes andere Element davor.';
$string['moduldescriptionectswrap'] = 'Element um den Credits-Satz';
$string['moduldescriptionectswrap_help'] = 'HTML-Element, das um den Satz gelegt wird. Erlaubt sind dl, div, ul, ol, p und blockquote. Leer lassen für keines. Evento schreibt jede Moduleigenschaft als eigene Definitionsliste, deshalb erzeugt die Vorgabe dl genau denselben Abstand wie zwischen zwei Eigenschaften. Ein Listenelement wie dt braucht ein dl darum herum.';
...
$string['moduldescriptionintro'] = 'Evento-Modulbeschreibung, Version {$a->version}, gültig ab {$a->validfrom}';
$string['moduldescriptionintroversion'] = 'Evento-Modulbeschreibung, Version {$a->version}';
$string['moduldescriptionintrovalidfrom'] = 'Evento-Modulbeschreibung, gültig ab {$a->validfrom}';
...
$string['eventmoduldescriptionsynced'] = 'Evento-Modulbeschreibung synchronisiert';
$string['eventosyncmoduldescription'] = 'Evento-Modulbeschreibungen synchronisieren';
$string['moduldescriptionserviceunavailable'] = 'Der Evento-Webservice ist nicht erreichbar, die Modulbeschreibung wird später übernommen.';
$string['moduldescriptiondisabled'] = 'Die Übernahme der Evento-Modulbeschreibungen ist in den Plugin-Einstellungen deaktiviert.';
$string['moduldescriptionpagedisabled'] = 'Die Aktivität "Textseite" ist systemweit deaktiviert, die Modulbeschreibung kann deshalb nicht angelegt werden.';
